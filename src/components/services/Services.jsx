    ...
    <div className="col-lg-3 col-sm-6 col-md-4 mb-1">
      <div className="row d-flex align-items-center">
        <div className="col-5 avatar w-100 white d-flex justify-content-center align-items-center">
          <img src={care} className="img-fluid  z-depth-1"  alt="homecare"  />
          </div>
          <div className="col-7">
            <h6 className="font-weight-bold text-center pt-2 ms-3">Personal care(Oral hygiene, Bathing & Dressing,Toileting, Skin care, Foot
care)</h6>
          </div>
      </div>
    </div>
    ...
    <div className="row d-flex align-items-center">
    <div className="col-5 avatar w-100 white d-flex justify-content-center align-items-center">
    <img src={pills} className="img-fluid  z-depth-1"  alt="homecare" />
    </div>
    <div className="col-7">
    ...
    <div className="row d-flex align-items-center">
    <div className="col-5 avatar w-100 white d-flex justify-content-center align-items-center">
    <img src={res} className="img-fluid  z-depth-1" alt="homecare"  />
    </div>
    <div className="col-7">
    ...
    <div className="row d-flex align-items-center">
    <div className="col-5 avatar w-100 white d-flex justify-content-center align-items-center">
    <img src={fall} className="img-fluid  z-depth-1"  alt="homecare"  />
    </div>
    <div className="col-7">
    ...
    <div className="row d-flex align-items-center">
    <div className="col-5 avatar w-100 white d-flex justify-content-center align-items-center">
    <img src={com} className="img-fluid  z-depth-1"  alt="homecare" />
    </div>
    <div className="col-7">
    ...
    <div className="row d-flex align-items-center">
    <div className="col-5 avatar w-100 white d-flex justify-content-center align-items-center">
    <img src={house} className="img-fluid  z-depth-1"  alt="homecare"  />
    </div>
    <div className="col-7">
    ...
    <div className="row d-flex align-items-center">
    <div className="col-5 avatar w-100 white d-flex justify-content-center align-items-center">
    <img src={grocery} className="img-fluid  z-depth-1"  alt="homecare" />
    </div>
    <div className="col-7">
    ...
    <div className="row d-flex align-items-center">
    <div className="col-5 avatar w-100 white d-flex justify-content-center align-items-center">
    <img src={dis} className="img-fluid  z-depth-1"  alt="homecare"  />
    </div>
    <div className="col-7">
    ...
    <div className="row d-flex align-items-center">
    <div className="col-5 avatar w-100 white d-flex justify-content-center align-items-center">
    <img src={daily} className="img-fluid  z-depth-1"  alt="homecare" />
    </div>
    <div className="col-7">
